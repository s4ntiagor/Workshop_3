...
def ETL():
    ...
    column_mappings_2016 = {
        'Country': 'country', ##crear para 2016 un column mapping con lower y upper
        'Region': 'region',
    ...
    df_2015.rename(columns=column_mappings_1516, inplace=True)
    ...
    df_2016.drop(['region', 'lower confidence interval', 'upper confidence interval', 'dystopia_residual'], axis=1, inplace=True)
    df_2017.drop(['whisker_high', 'whisker_low', 'dystopia_residual'], axis=1, inplace=True)
